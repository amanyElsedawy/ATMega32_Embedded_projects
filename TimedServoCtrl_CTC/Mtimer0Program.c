...
void MTMR1_voidInit_PMWServo(u8 Copy_u8LocalAngle) {
   ...
   // u16 Local_u16OCR1A;
    ...
    if(Copy_u8LocalAngle>180){
    	Copy_u8LocalAngle=180;
    }
    Local_pulseWidth=600+((u32)Copy_u8LocalAngle*(2500-600)/180);
    private_u16_OCR1A = Local_pulseWidth;
